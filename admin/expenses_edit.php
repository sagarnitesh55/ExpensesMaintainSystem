...
?>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4"> 
          ...
          <div style="width: 100%; background-color: #f2f4f4">
              ...
              <form style="margin: 3%; padding: 3%;" method="POST" name="expenses_form" id="expenses_form">
                <div id="msg"></div>
                <div class="form-row mt-4">
                    <div class="form-group col-lg-6 col-sm-12">
                        <label for="name">Name</label>
                        <input type="name" class="form-control" id="name" name="name" placeholder="Name" value="<?php echo $name; ?>">
                    </div>
                    <div class="form-group col-lg-6 col-sm-12">
                        <label for="rupees">Rupees </label>
                        <input type="number" class="form-control" id="rupees" name="rupees" placeholder="Rupees" value="<?php echo $rupees; ?>">
                    </div>
                </div>
                 <div class="form-row mt-4">
                    <div class="form-group col-lg-6 col-sm-12">
                 ...
                 <div class="form-row mt-4">
                    ...
                    <div class="form-group col-lg-6 col-sm-12">
                        ...
                        <input type="name" class="form-control" id="paid_by" name="paid_by" placeholder="Paid By" value="<?php echo $paid_by; ?>">
                    </div>
                </div>
                 <div class="form-row mt-4">
                    <div class="form-group col-lg-6 col-sm-12">
                 ...
                 <?php   
                  ...
                  <div class="form-row mt-4">
                   ...
                   <!-- <div class="form-row mt-4"> -->
                    ...
                    <!-- <div class="form-group col-lg-6 col-sm-12">
                        <label for="is_active">Is Approved</label>
    ...
    <?php
        ...
        if (isset($_POST['submit'])) {
             ...
             $is_approved= $_POST['is_approved'];
              ...
              $query1 = mysqli_query($db, "UPDATE expenses SET name='$name', rupees='$rupees', tenure='$tenure', date='$date', mode_of_payment='$mode_of_payment', paid_by='$paid_by', created_by='$created_by', images='$images', remarks='$remarks', transaction_id='$transaction_id', is_approved='$is_approved'  WHERE id='$id' ");
