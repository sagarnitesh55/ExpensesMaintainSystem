...
?>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4"> 
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
       ...
       <h1 class="h2">Unapproved Expenses</h1> 
          ...
          <tbody>
             ...
             <?php 
              include('connection/db.php'); 
               ...
               $query= mysqli_query($db, "select * from expenses where is_approved='No' " );
              ...
              <tr>
                ...
                <td><?php echo $row ['is_approved']; ?></td>
                 ...
                 <td>
                    <div class="row">
                      <div class="btn-group">
                        <a href="expenses_approved.php?approve_expense=<?php echo $row['id']; ?>" class="btn btn-primary"><span><i class="fas fa-check"></i></span></a>
                        <a href="expenses_disapprove.php?del=<?php echo $row['id']; ?>" class="btn btn-danger"><span> <i class="fas fa-trash"></i></span></a>
